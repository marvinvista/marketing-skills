...
- Product mechanic: generate a controlled variant matrix across hooks, angles, proof, CTAs, and formats
- Output: creative variant matrix
- Evidence surfaces: ad-creative-generation, message-testing

## When To Use

Create structured ad variants for controlled creative testing.
...
- Specific constraints, examples, and existing assets for ad variant matrix builder
...
- Confirm the user needs the `generate a controlled variant matrix across hooks, angles, proof, CTAs, and formats` mechanic and identify the audience, artifact, and review owner.
- Collect only the inputs needed for Ad creative generation, Message testing; infer low-risk defaults and mark missing high-risk fields.
- Map each surface to the artifact fields before drafting recommendations.
- Apply the decision rules in `references/pattern.md` before drafting the artifact.
- Return creative variant matrix with QA checks, failure modes, metric, and next action.

## Artifact Template

- Context and decision the artifact supports
- Input table with owner, freshness, and gaps
- Mechanic-specific work product for ad variant matrix builder
- Decision rules applied and tradeoffs
- QA checklist, failure modes, metric, and next action

## Skill-Specific Work Product

- Final artifact: creative variant matrix.
- Organizing mechanic: generate a controlled variant matrix across hooks, angles, proof, CTAs, and formats.
- Core fields or sections: hook, angle, proof, format, CTA, variable changed, hypothesis, review state.
...
Use $ad-variant-matrix-builder to create creative variant matrix for a marketing task in Creative / Ads / Assets. Apply the Ad creative generation, Message testing mechanics and return the QA checks, failure modes, proof metric, and next action.

## Optional Helper

Use `scripts/build_variant_matrix.py` when inputs are structured. Generate a controlled creative variant CSV from simple option lists.
