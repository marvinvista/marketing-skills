...
- Product mechanic: score brand visibility, answer accuracy, citation quality, and next-action usefulness across answer surfaces
- Output: visibility scorecard with remediation backlog
- Evidence surfaces: ai-search-visibility-monitoring, answer-source-remediation

## When To Use

Audit how a brand, product, or category appears in AI answers.
...
- Specific constraints, examples, and existing assets for AI answer visibility scorecard
...
- Confirm the user needs the `score brand visibility, answer accuracy, citation quality, and next-action usefulness across answer surfaces` mechanic and identify the audience, artifact, and review owner.
...
- Return visibility scorecard with remediation backlog with QA checks, failure modes, metric, and next action.

## Artifact Template

- Context and decision the artifact supports
- Input table with owner, freshness, and gaps
- Mechanic-specific work product for AI answer visibility scorecard
- Decision rules applied and tradeoffs
- QA checklist, failure modes, metric, and next action

## Skill-Specific Work Product

- Final artifact: visibility scorecard with remediation backlog.
- Organizing mechanic: score brand visibility, answer accuracy, citation quality, and next-action usefulness across answer surfaces.
- Core fields or sections: prompt, surface, mention status, rank, answer accuracy, citation quality, next action, risk.
...
Use $ai-answer-visibility-scorecard to create visibility scorecard with remediation backlog for a marketing task in AI Search / Agent Discovery. Apply the AI search visibility monitoring, Answer source remediation mechanics and return the QA checks, failure modes, proof metric, and next action.
