...
- Product mechanic: write content briefs for missing questions with answer structure, evidence, and schema needs
- Output: answer-ready content brief
- Evidence surfaces: seo-content-briefing, answer-source-remediation

## When To Use

Produce briefs for answer-ready pages or docs.
...
- Specific constraints, examples, and existing assets for answer-ready content brief
...
- Confirm the user needs the `write content briefs for missing questions with answer structure, evidence, and schema needs` mechanic and identify the audience, artifact, and review owner.
...
- Return answer-ready content brief with QA checks, failure modes, metric, and next action.

## Artifact Template

- Context and decision the artifact supports
- Input table with owner, freshness, and gaps
- Mechanic-specific work product for answer-ready content brief
- Decision rules applied and tradeoffs
- QA checklist, failure modes, metric, and next action

## Skill-Specific Work Product

- Final artifact: answer-ready content brief.
- Organizing mechanic: write content briefs for missing questions with answer structure, evidence, and schema needs.
- Core fields or sections: target question, intent, answer block, proof, schema need, internal link, content owner, publish check.
...
Use $answer-ready-content-brief to create answer-ready content brief for a marketing task in AI Search / Agent Discovery. Apply the SEO content briefing, Answer source remediation mechanics and return the QA checks, failure modes, proof metric, and next action.
