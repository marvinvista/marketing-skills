...
- Product mechanic: define UTMs, events, properties, destinations, QA checks, and reporting owner
- Output: campaign tracking plan
- Evidence surfaces: campaign-analytics-qa, marketing-ops-orchestration

## When To Use

Plan campaign tracking before launch with QA ownership.
...
- Specific constraints, examples, and existing assets for campaign tracking plan
...
- Confirm the user needs the `define UTMs, events, properties, destinations, QA checks, and reporting owner` mechanic and identify the audience, artifact, and review owner.
...
- Return campaign tracking plan with QA checks, failure modes, metric, and next action.

## Artifact Template

- Context and decision the artifact supports
- Input table with owner, freshness, and gaps
- Mechanic-specific work product for campaign tracking plan
- Decision rules applied and tradeoffs
- QA checklist, failure modes, metric, and next action

## Skill-Specific Work Product

- Final artifact: campaign tracking plan.
- Organizing mechanic: define UTMs, events, properties, destinations, QA checks, and reporting owner.
- Core fields or sections: channel, UTM, event, property, conversion, destination, owner, QA step.
...
Use $campaign-tracking-plan to create campaign tracking plan for a marketing task in Lifecycle / Ops / Analytics. Apply the Campaign analytics QA, Marketing ops orchestration mechanics and return the QA checks, failure modes, proof metric, and next action.
