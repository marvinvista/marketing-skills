...
- Product mechanic: convert audience insight, proof, and objections into a production-ready creative brief
- Output: creative brief with claims, proof, and constraints
- Evidence surfaces: ad-creative-generation, customer-research-synthesis

## When To Use

Turn research into a brief for ads, landing pages, or assets.
...
- Specific constraints, examples, and existing assets for creative brief from research
...
- Confirm the user needs the `convert audience insight, proof, and objections into a production-ready creative brief` mechanic and identify the audience, artifact, and review owner.
...
- Return creative brief with claims, proof, and constraints with QA checks, failure modes, metric, and next action.

## Artifact Template

- Context and decision the artifact supports
- Input table with owner, freshness, and gaps
- Mechanic-specific work product for creative brief from research
- Decision rules applied and tradeoffs
- QA checklist, failure modes, metric, and next action

## Skill-Specific Work Product

- Final artifact: creative brief with claims, proof, and constraints.
- Organizing mechanic: convert audience insight, proof, and objections into a production-ready creative brief.
- Core fields or sections: insight, audience, claim, proof, objection, format, CTA, production constraint, reviewer.
...
Use $creative-brief-from-research to create creative brief with claims, proof, and constraints for a marketing task in Creative / Ads / Assets. Apply the Ad creative generation, Customer research synthesis mechanics and return the QA checks, failure modes, proof metric, and next action.
