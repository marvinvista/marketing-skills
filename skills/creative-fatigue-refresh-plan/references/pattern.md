...
- Product mechanic: diagnose creative fatigue and plan refreshes by angle, asset, audience, and format
- Output: creative refresh plan
- Evidence surfaces: ad-creative-generation, campaign-analytics-qa

## When To Use

Refresh fatigued creative without resetting the learning loop.
...
- Specific constraints, examples, and existing assets for creative fatigue refresh plan
...
- Confirm the user needs the `diagnose creative fatigue and plan refreshes by angle, asset, audience, and format` mechanic and identify the audience, artifact, and review owner.
...
- Return creative refresh plan with QA checks, failure modes, metric, and next action.

## Artifact Template

- Context and decision the artifact supports
- Input table with owner, freshness, and gaps
- Mechanic-specific work product for creative fatigue refresh plan
- Decision rules applied and tradeoffs
- QA checklist, failure modes, metric, and next action

## Skill-Specific Work Product

- Final artifact: creative refresh plan.
- Organizing mechanic: diagnose creative fatigue and plan refreshes by angle, asset, audience, and format.
- Core fields or sections: fatigued asset, symptom, retained learning, variable to refresh, new angle, audience, relaunch check.
...
Use $creative-fatigue-refresh-plan to create creative refresh plan for a marketing task in Creative / Ads / Assets. Apply the Ad creative generation, Campaign analytics QA mechanics and return the QA checks, failure modes, proof metric, and next action.
