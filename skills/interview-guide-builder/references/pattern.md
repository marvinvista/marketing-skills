...
- Product mechanic: create interview guides tied to buyer questions, objections, alternatives, and decision criteria
- Output: interview guide
- Evidence surfaces: customer-research-synthesis

## When To Use

Create customer, buyer, or stakeholder interview guides.
...
- Specific constraints, examples, and existing assets for interview guide builder
...
- Confirm the user needs the `create interview guides tied to buyer questions, objections, alternatives, and decision criteria` mechanic and identify the audience, artifact, and review owner.
...
- Return interview guide with QA checks, failure modes, metric, and next action.

## Artifact Template

- Context and decision the artifact supports
- Input table with owner, freshness, and gaps
- Mechanic-specific work product for interview guide builder
- Decision rules applied and tradeoffs
- QA checklist, failure modes, metric, and next action

## Skill-Specific Work Product

- Final artifact: interview guide.
- Organizing mechanic: create interview guides tied to buyer questions, objections, alternatives, and decision criteria.
- Core fields or sections: buyer question, objection, alternative, decision criterion, prompt, probe, segment, evidence label.
...
Use $interview-guide-builder to create interview guide for a marketing task in Research / Audience Simulation. Apply the Customer research synthesis mechanics and return the QA checks, failure modes, proof metric, and next action.
