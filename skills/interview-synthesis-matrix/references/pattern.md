...
- Product mechanic: synthesize interviews into themes, quotes, objections, segments, confidence, and implications
- Output: interview synthesis matrix
- Evidence surfaces: customer-research-synthesis

## When To Use

Turn interviews into a decision-ready matrix with confidence notes.
...
- Specific constraints, examples, and existing assets for interview synthesis matrix
...
- Confirm the user needs the `synthesize interviews into themes, quotes, objections, segments, confidence, and implications` mechanic and identify the audience, artifact, and review owner.
...
- Return interview synthesis matrix with QA checks, failure modes, metric, and next action.

## Artifact Template

- Context and decision the artifact supports
- Input table with owner, freshness, and gaps
- Mechanic-specific work product for interview synthesis matrix
- Decision rules applied and tradeoffs
- QA checklist, failure modes, metric, and next action

## Skill-Specific Work Product

- Final artifact: interview synthesis matrix.
- Organizing mechanic: synthesize interviews into themes, quotes, objections, segments, confidence, and implications.
- Core fields or sections: theme, quote, segment, objection, alternative, confidence, implication, next evidence.
...
Use $interview-synthesis-matrix to create interview synthesis matrix for a marketing task in Research / Audience Simulation. Apply the Customer research synthesis mechanics and return the QA checks, failure modes, proof metric, and next action.
