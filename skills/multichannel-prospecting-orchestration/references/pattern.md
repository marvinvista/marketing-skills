...
- Product mechanic: coordinate email, LinkedIn, phone, retargeting, chat, and sales owner handoff
- Output: multichannel prospecting map
- Evidence surfaces: outbound-cadence-automation, marketing-ops-orchestration

## When To Use

Coordinate prospecting across channels with owner handoff rules.
...
- Specific constraints, examples, and existing assets for multichannel prospecting orchestration
...
- Confirm the user needs the `coordinate email, LinkedIn, phone, retargeting, chat, and sales owner handoff` mechanic and identify the audience, artifact, and review owner.
- Collect only the inputs needed for Outbound cadence automation, Marketing ops orchestration; infer low-risk defaults and mark missing high-risk fields.
- Map each surface to the artifact fields before drafting recommendations.
- Apply the decision rules in `references/pattern.md` before drafting the artifact.
- Return multichannel prospecting map with QA checks, failure modes, metric, and next action.

## Artifact Template

- Context and decision the artifact supports
- Input table with owner, freshness, and gaps
- Mechanic-specific work product for multichannel prospecting orchestration
- Decision rules applied and tradeoffs
- QA checklist, failure modes, metric, and next action

## Skill-Specific Work Product

- Final artifact: multichannel prospecting map.
- Organizing mechanic: coordinate email, LinkedIn, phone, retargeting, chat, and sales owner handoff.
- Core fields or sections: channel, step, trigger, owner, handoff, suppression, fallback, reporting field.
...
Use $multichannel-prospecting-orchestration to create multichannel prospecting map for a marketing task in Lead Intelligence / Conversion. Apply the Outbound cadence automation, Marketing ops orchestration mechanics and return the QA checks, failure modes, proof metric, and next action.
