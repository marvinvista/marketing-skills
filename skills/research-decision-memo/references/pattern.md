...
- Product mechanic: convert research findings into a recommendation, confidence level, rejected options, and next evidence
- Output: research decision memo
- Evidence surfaces: customer-research-synthesis

## When To Use

Turn research into a decision with confidence and tradeoffs.
...
- Specific constraints, examples, and existing assets for research decision memo
...
- Confirm the user needs the `convert research findings into a recommendation, confidence level, rejected options, and next evidence` mechanic and identify the audience, artifact, and review owner.
...
- Return research decision memo with QA checks, failure modes, metric, and next action.

## Artifact Template

- Context and decision the artifact supports
- Input table with owner, freshness, and gaps
- Mechanic-specific work product for research decision memo
- Decision rules applied and tradeoffs
- QA checklist, failure modes, metric, and next action

## Skill-Specific Work Product

- Final artifact: research decision memo.
- Organizing mechanic: convert research findings into a recommendation, confidence level, rejected options, and next evidence.
- Core fields or sections: decision, evidence, finding, confidence, option rejected, recommendation, next evidence, owner.
...
Use $research-decision-memo to create research decision memo for a marketing task in Research / Audience Simulation. Apply the Customer research synthesis mechanics and return the QA checks, failure modes, proof metric, and next action.
