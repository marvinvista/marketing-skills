...
- Product mechanic: write survey questions, screeners, branching, scales, and analysis fields around a decision
- Output: survey instrument and analysis plan
- Evidence surfaces: customer-research-synthesis, message-testing

## When To Use

Design surveys that answer a marketing decision.
...
- Specific constraints, examples, and existing assets for survey instrument builder
...
- Confirm the user needs the `write survey questions, screeners, branching, scales, and analysis fields around a decision` mechanic and identify the audience, artifact, and review owner.
...
- Return survey instrument and analysis plan with QA checks, failure modes, metric, and next action.

## Artifact Template

- Context and decision the artifact supports
- Input table with owner, freshness, and gaps
- Mechanic-specific work product for survey instrument builder
- Decision rules applied and tradeoffs
- QA checklist, failure modes, metric, and next action

## Skill-Specific Work Product

- Final artifact: survey instrument and analysis plan.
- Organizing mechanic: write survey questions, screeners, branching, scales, and analysis fields around a decision.
- Core fields or sections: decision, respondent criteria, screener, question, scale, branch, analysis field, bias check.
...
Use $survey-instrument-builder to create survey instrument and analysis plan for a marketing task in Research / Audience Simulation. Apply the Customer research synthesis, Message testing mechanics and return the QA checks, failure modes, proof metric, and next action.
