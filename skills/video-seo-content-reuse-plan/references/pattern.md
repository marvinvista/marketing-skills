...
- Product mechanic: convert video assets into search-answer blocks, social cuts, proof moments, and reuse ownership
- Output: video SEO reuse plan
- Evidence surfaces: video-ad-production, seo-content-briefing, social-content-automation

## When To Use

Repurpose video production into SEO and social content assets.
...
- Specific constraints, examples, and existing assets for video SEO content reuse plan
...
- Confirm the user needs the `convert video assets into search-answer blocks, social cuts, proof moments, and reuse ownership` mechanic and identify the audience, artifact, and review owner.
- Collect only the inputs needed for Video ad production, SEO content briefing, Social content automation; infer low-risk defaults and mark missing high-risk fields.
- Map each surface to the artifact fields before drafting recommendations.
- Apply the decision rules in `references/pattern.md` before drafting the artifact.
- Return video SEO reuse plan with QA checks, failure modes, metric, and next action.

## Artifact Template

- Context and decision the artifact supports
- Input table with owner, freshness, and gaps
- Mechanic-specific work product for video SEO content reuse plan
- Decision rules applied and tradeoffs
- QA checklist, failure modes, metric, and next action

## Skill-Specific Work Product

- Final artifact: video SEO reuse plan.
- Organizing mechanic: convert video assets into search-answer blocks, social cuts, proof moments, and reuse ownership.
- Core fields or sections: video asset, transcript moment, target query, answer block, social cut, proof, reuse owner, publish check.
...
Use $video-seo-content-reuse-plan to create video SEO reuse plan for a marketing task in Creative / Ads / Assets. Apply the Video ad production, SEO content briefing, Social content automation mechanics and return the QA checks, failure modes, proof metric, and next action.
